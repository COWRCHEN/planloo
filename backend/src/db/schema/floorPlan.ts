...
export const objectTemplates = sqliteTable('object_templates', {
  ...
  seatTop: integer('seat_top'),
  seatBottom: integer('seat_bottom'),
  seatLeft: integer('seat_left'),
  seatRight: integer('seat_right'),
...
export const floorPlans = sqliteTable('floor_plans', {
  ...
  widthFt: real('width_ft').notNull().default(1000),
  heightFt: real('height_ft').notNull().default(800),
  gridSnap: integer('grid_snap').notNull().default(10),
...
export const floorPlanObjects = sqliteTable('floor_plan_objects', {
  ...
  label: text('label').notNull(),
  posX: real('pos_x').notNull().default(100),
  posY: real('pos_y').notNull().default(100),
  widthFt: real('width_ft').notNull().default(60),
  heightFt: real('height_ft').notNull().default(60),
