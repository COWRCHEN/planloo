 ...
 * Tables Landing View
 *
 * Shows a list of events with links to their seating charts.
 */
    ...
    return (
      <Card>
        <CardContent className="py-12 text-center">
          <p className="text-muted-foreground">Please sign in to manage seating charts.</p>
      ...
      <Card>
        <CardContent className="py-12 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Create an event first to start designing seating charts.
          </p>
          <Button asChild className="mt-4">
...
export function TablesLandingView() {
  return (
    <QueryProvider>
      <TablesLandingContent />
    </QueryProvider>
  );
}
